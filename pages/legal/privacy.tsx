        ...
        <>
            <article className="prose dark:prose-dark">
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to Damned Cat Studio, accessible from <a href="http://damnedcat.studio" rel="external nofollow noopener" target="_blank">http://damnedcat.studio</a></p>
                    </li>
                    <li>
