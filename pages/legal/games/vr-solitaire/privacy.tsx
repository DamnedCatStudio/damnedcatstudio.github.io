  ...
  return (
    <>
      <article className="prose dark:prose-dark max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8 lg:py-24">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Damned Cat Studio.
            </p>
          </li>
          <li>
            <p>
        ...
        <p>
          Meta, formerly Oculus probably collects your data. However, we DO NOT
          and we DO NOT see any data that they might be collecting.
        </p>
        <p>
        ...
        <ul>
          <li>
            ...
            <a
              href="https://damnedcat.studio/contact"
              rel="noreferrer external nofollow noopener"
              target="_blank"
            >
              https://damnedcat.studio/contact
            </a>
          </li>
        </ul>
        <h2>Deleting your Personal Information</h2>
        <p>
          As laid out in this privacy policy; we DO NOT collect any personal
          data. That being said Meta requires us to tell you how to delete it.
          So just delete the Application.
        </p>
      </article>
    </>
  );
