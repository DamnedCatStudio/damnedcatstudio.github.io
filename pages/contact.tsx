  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:title"
          content="Contact Us :: Damned Cat Studio"
          key="title"
        />
        <meta
          name="description"
          content="Need to reach us? Contact us on this fancy page!"
          key="description"
        />
        ...
        <div className="relative max-w-xl mx-auto">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg leading-6 text-gray-700 dark:text-gray-300">
              Have an idea? Want to talk about an upcoming project or join in
              our shinanigans?
            </p>
          </div>
          <div className="mt-12">
                ...
                <div className="mt-1 relative rounded-md shadow-sm">
                  <div className="absolute inset-y-0 left-0 flex items-center">
                    ...
                    <select
                      id="country"
                      name="country"
                      className="h-full py-0 pl-4 pr-8 border-transparent bg-transparent text-gray-700 focus:ring-amber-600 focus:border-amber-600 rounded-md"
                    >
                      <option>US</option>
                      <option>CA</option>
                      <option>EU</option>
