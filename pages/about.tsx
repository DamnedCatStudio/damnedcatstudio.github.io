...
const people = [
    {
        ...
        linkedinUrl: 'https://linkedin.com/in/johnweland',
    },
    {
        name: 'Timothy Jeske',
        role: 'Co-Founder | COO',
        imageUrl:
            '/images/tjeske.jpeg',
        twitterUrl: 'https://twitter.com/GausRoth/',
        linkedinUrl: 'https://www.linkedin.com/in/timothy-jeske-8254a690/',
    },
]
const About = ({ }) => {
    return (
        <>
            <Head>
                ...
                <meta name="description" content="About the team of Damned Cat Studio" key="description" />
                        ...
                        {people.map((person) => (
                            <li key={person.name}>
                                <div className="space-y-6">
                                    <Image className="mx-auto h-40 w-40 rounded-full xl:w-56 xl:h-56 object-cover" width={200} height={200} src={person.imageUrl} alt="" />
